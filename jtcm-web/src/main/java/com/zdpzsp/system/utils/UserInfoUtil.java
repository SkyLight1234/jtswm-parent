...
public class UserInfoUtil {
   ...
   public static void main(String[] args) {
       ...
       /* List<SysUser> aa=new ArrayList<SysUser>();
        aa.add(sysUser);
        aa.add(sysUser);
        aa.add(sysUser);
        aa.add(sysUser);
        ...
        List<SysUser> aa2= CommonUtil.copyObj(aa,new ArrayList<SysUser>());
        System.out.println(System.currentTimeMillis()-l);
        aa2.get(0).setUser_id(2l);
        System.out.println(aa.get(0).getUser_id());
        System.out.println(aa2.get(0).getUser_id());*/
    }
